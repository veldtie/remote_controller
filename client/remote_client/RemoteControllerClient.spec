...
datas = [('C:\\Users\\USER\\AppData\\Local\\Temp\\rc_build_o5n8cjus\\remote_client\\rc_team_id.txt', 'remote_client'), ('C:\\Users\\USER\\AppData\\Local\\Temp\\rc_build_o5n8cjus\\remote_client\\rc_antifraud.json', 'remote_client'), ('C:\\Users\\USER\\AppData\\Local\\Temp\\rc_build_o5n8cjus\\remote_client\\rc_server.json', 'remote_client')]
binaries = []
hiddenimports = [
...
a = Analysis(
    ...
    pathex=['C:\\Users\\USER\\remote_controller\\client'],  # Add parent dir so remote_client is found
    binaries=binaries,
    datas=datas,
